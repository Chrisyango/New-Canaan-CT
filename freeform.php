...
<head>
	...
	<title>New Canaan, CT - Freeform</title>
...
<section id="quick-links">
	<div class="container">
		<h2 class="col-md-4">health department:</h2>
		<div id="quick-links-container" class="col-md-8">
			...
			<div class="col-md-8">
				<article id="entry">
					<div id="post">
						...
						<ul>
							<li><a href="./">lyme disease information</a></li>
							<li><a href="./">winter weather preparedness</a></li>
							<li><a href="./">service contractors</a></li>
						</ul>
					</div><!-- /#post -->
				</article><!-- /#entry -->
			</div><!-- /.col-md-9 -->
			<div class="col-md-4">
				<aside id="side-content" class="fillRight withPadding">
					<div id="flyout-wrap">
						<ul id="flyout">
							<li>
								...
								<ul>
									...
									<li><a href="./">conservation guidance</a></li>
									<li><a href="./">innovation & trends</a></li>
								</ul>
							</li>
							<li>
								...
								<ul>
									...
									<li><a href="./">the ct agricultural experimental station</a></li>
									<li><a href="./">department of environmental protection</a></li>
								</ul>
							</li>
							<li>
								<a href="./">state of connecticut sites:</a>
								<ul>
									...
									<li><a href="./">food and drug administration</a></li>
